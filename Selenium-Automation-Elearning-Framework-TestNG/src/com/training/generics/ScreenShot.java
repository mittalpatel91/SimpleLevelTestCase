...
public class ScreenShot {
	...
	public void captureScreenShot(){
		...
		// to be changed 
		String path = "C:\\IBM_Selenium_Project\\screenshots\\";
		String fileName ="";
	...
	public void captureScreenShot(String fileName){
		...
		try {
			...
			int minute = calendar.get(Calendar.MINUTE);
			int second = calendar.get(Calendar.SECOND); 
			FileUtils.copyFile(file, new File(path +new Integer(date).toString() + "-" + new Integer(minute).toString() +"-" +
					new Integer(second).toString()+fileName+".png"));
		} catch (WebDriverException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
